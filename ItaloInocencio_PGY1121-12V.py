...
def grabar():
    ...
    fecha = input("Ingrese fecha registro de vehículo.")
    ...
    storage[patente] = {'nombre':nombre,'tipo':tipo,'marca':marca,'fecha':fecha,'precio':precio,'multas(m)': multas_monto,'multas(f)': multas_fecha}
    print(storage)
